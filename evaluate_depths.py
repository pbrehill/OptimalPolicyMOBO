...
# Depth 1
## All vars
df_results, time_taken = fit_frontier(X, G1, G2, num_trials=NUM_TRIALS, search_depth=1, depth=1)
df_results.to_csv("vbd1.csv")

## Limited vars
df_results, time_taken = fit_frontier(X_lim, G1, G2, num_trials=NUM_TRIALS, search_depth=1, depth=1)
df_results.to_csv("vsd1.csv")

## Very limited vars
df_results, time_taken = fit_frontier(X_vlim, G1, G2, num_trials=NUM_TRIALS, search_depth=1, depth=1)
df_results.to_csv("vtd1.csv")

# Depth 2
## All vars
df_results, time_taken = fit_frontier(X, G1, G2, num_trials=NUM_TRIALS, search_depth=1, depth=2)
df_results.to_csv("vbd2.csv")

## Limited vars
df_results, time_taken = fit_frontier(X_lim, G1, G2, num_trials=NUM_TRIALS, search_depth=1, depth=2)
